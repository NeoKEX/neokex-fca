...
const axiosHelpers = require("../lib/utils/helpers/axios");
...
const setProxy = axiosHelpers.setProxy;
...
const cleanGet = axiosHelpers.cleanGet;
const get = axiosHelpers.get;
const post = axiosHelpers.post;
const postFormData = axiosHelpers.postFormData;
...
const logPrefix = chalk.hex('#2563eb').bold('[NeoKEX-FCA]');
const timestamp = () => chalk.gray(new Date().toLocaleTimeString('en-US', { hour12: false }));

module.exports = {
  log(...args) {
    console.log(timestamp(), logPrefix, chalk.hex('#10b981')('✓'), ...args);
  },
  error(...args) {
    console.error(timestamp(), logPrefix, chalk.hex('#ef4444')('✗'), chalk.red(...args));
  },
  warn(...args) {
    console.warn(timestamp(), logPrefix, chalk.hex('#f59e0b')('⚠'), chalk.yellow(...args));
  },
  isReadableStream,
  cleanGet,
  get,
