...
function getHeaders(url, options, ctx, customHeader) {
    ...
    if (ctx && ctx.antiDetectionManager && options && options.randomUserAgent) {
        const antiDetectionUA = ctx.antiDetectionManager.getUserAgent();
        userAgentData = randomUserAgent();
        userAgentData.userAgent = antiDetectionUA;
    } else {
        userAgentData = randomUserAgent();
    }
